    ...
    const stream = await agent.stream([
      {
        ...
        content: {
          ...
          parts: [
            {
              type: 'text',
              text: 'How long are invoices retained and who approves archive access?',
              createdAt: 1_789_860_800_575,
            },
          ],
          metadata: { signal: { type: 'user', clientMessageId: 'client-set-message' } },
        },
      },
    ] as never);
    const parts = [];
